...
function [features_on_the_poles_pairs] = part3(images, setFiles, Pcs_homog, matching_sift_pairs, s, setNum)
    ...
    for i = 1: length(Pcs_homog) - 1
        ...
        for j = i+1: length(Pcs_homog)
            ...
            [features_on_epipole1, features_on_epipole2] = find_features_on_poles(s, f1, f2, fundMat, e1, e2, image1, image2, imFilename1, imFilename2, setNum);
